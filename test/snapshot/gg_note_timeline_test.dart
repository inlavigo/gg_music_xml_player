...
import 'package:gg_music_xml_player/src/timeline/gg_note_timeline.dart';
import 'package:test/test.dart';
import 'package:fake_async/fake_async.dart';

void main() {
  late GgNoteItems timeline = exampleNoteTimeline();
  ...
  group('GgItemGenerator', () {
    ...
    group('initialization', () {
      ...
      test('should load ties correctly', () {
        final itemGenerator = GgNoteItems(part: tieXmlDoc.parts.first);
