...
import 'package:gg_music_xml_player/src/timelines/gg_document_timeline.dart';
...
void main() {
  ...
  final oneFrame = GgTimeController.defaultFrameDuration.ggDuration;
      ...
      test('should be called when a item was updated', () {
        fakeAsync(
          (fake) {
            ...
            restTime = 0.01;
            fake.elapse((lastItem.validTo - restTime).ggDuration);
            fake.flushMicrotasks();
            ...
            fake.elapse(restTime.ggDuration + oneFrame);
            fake.flushMicrotasks();
            ...
            // Wait to next item
            fake.elapse(currentItem!.duration.ggDuration);
